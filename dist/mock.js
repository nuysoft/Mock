var Mock = (function () {
    ...
    */
    ...
    Util$1.extend = function extend() {
        ...
        for (; i < length; i++) {
            ...
            for (name in options) {
                ...
                if (Util$1.isArray(copy) || Util$1.isObject(copy)) {
                    if (Util$1.isArray(copy)) clone = src && Util$1.isArray(src) ? src : [];
                    if (Util$1.isObject(copy)) clone = src && Util$1.isObject(src) ? src : {};

                    target[name] = Util$1.extend(clone, copy);
                } else {
                    target[name] = copy;
                }
            }
    ...
    Util$1.each = function each(obj, iterator, context) {
        var i, key;
    ...
    Util$1.type = function type(obj) {
        return (obj === null || obj === undefined) ? String(obj) : Object.prototype.toString.call(obj).match(/\[object (\w+)\]/)[1].toLowerCase()
    };

    Util$1.each('String Object Array RegExp Function'.split(' '), function(value) {
        Util$1['is' + value] = function(obj) {
            return Util$1.type(obj) === value.toLowerCase()
        };
    });

    Util$1.isObjectOrArray = function(value) {
        return Util$1.isObject(value) || Util$1.isArray(value)
    };

    Util$1.isNumeric = function(value) {
        return !isNaN(parseFloat(value)) && isFinite(value)
    };

    Util$1.keys = function(obj) {
        var keys = [];
        for (var key in obj) {
    ...
    */
    Util$1.heredoc = function heredoc(fn) {
        // 1. 移除起始的 function(){ /*!
        // 2. 移除末尾的 */ }
        // 3. 移除起始和末尾的空格
        return fn.toString()
    ...
    */
    ...
    var XHR;
    if (typeof window !== 'undefined') XHR = xhr;
