...
*/
define('mock/random/color',[],function() {
	...
	return {
		_colorConversions: conversions,
		// 随机生成一个有吸引力的颜色，格式为 '#RRGGBB'。
		color: function() {
			return this._brainlessColor()
		},
		...
		_goldenRatioColor: function(saturation, value) {
			...
			var rgb = this._colorConversions.hsv2rgb(hsv)
			return 'rgb(' +
				parseInt(rgb[0], 10) + ', ' +
				parseInt(rgb[1], 10) + ', ' +
				parseInt(rgb[2], 10) + ')'
...
/*
    ...
    **排序**
    ...
    ```
*/
define('mock/random/address_dict.js',[],function() {
    var DICT = {
        "110000": "北京",
        "110100": "北京市",
        "110101": "东城区",
...
/*
	...
	* Parser.parse( name )
		...
		```
 */
define('mock/parser',['mock/constant', 'mock/random/random'], function(Constant, Random) {
	/* jshint -W041 */
	return {
		parse: function(name) {
...
define('mock/regexp/parser',[], function() {
 ...
 */
define('mock/regexp/handler',['mock/util', 'mock/random/random'], function(Util, Random) {
    /*
 ...
 */
define('mock/xhr/xhr',['mock/util'], function(Util) {
    // 备份原生 XMLHttpRequest
