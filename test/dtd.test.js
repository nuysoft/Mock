...
describe('DTD', function () {
    describe('Literal', function () {
        ...
        it([], function () {
            const arr = [];
            var data = Mock.mock(arr);
            expect(data).to.deep.equal(arr);
        });
    ...
    describe('Number', function () {
        ...
        it('name|+step', function () {
            ...
            _.each(data.list, function (item, index) {
                ...
                else expect(item.name).to.equal(data.list[index - 1].name + 1);
            });
        });
    ...
    describe('Array', function () {
        ...
        it('name|1 [{}, {}, {}]', function () {
            ...
            expect(value.map((i) => i.method)).include(data.name.method);
        });
